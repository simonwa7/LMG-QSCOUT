...
from qscout.v1 import native_gates, noisy
from ansatz import prepare_state, add_cnot_gate, add_hadamard_gate

SIM_GATES = native_gates.NATIVE_GATES.copy()


def create_clique1_circuit(circuit_parameters, number_of_qubits):
    builder = jql.core.circuitbuilder.CircuitBuilder(native_gates=SIM_GATES)
...
def get_measurements_for_clique(
    ...
    **jaqal_emulator_kwargs
    ...
    bitstrings = [
        format(i, "0{}b".format(number_of_qubits))[::-1] for i in range(2 ** number_of_qubits)
    ]
